...
import { changeProgramStatus, createMentor, createProgram, enrollIntern, getAllInterns, getAllMentors, getAllPrograms, getAvailableInterns, updateInternStatus, updateProgram } from '../controllers/adminController.js'
